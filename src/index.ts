...
export const APP_ENV = {
  ...
  APP_NAME: process.env?.APP_NAME || 'vid-api',
  ...
  JWT_SUBJECT: process.env?.JWT_SUBJECT || 'anonymouse@vid-api.com',
  JWT_AUDIENCE: process.env?.JWT_AUDIENCE || 'https://vid-api.com',
